...
(async () => {
  ...
  await fs.writeFile("hemiplegia-and-paraplegia-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("hemiplegia-and-paraplegia-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
